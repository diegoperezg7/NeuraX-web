...
export function MenuBar() {
  ...
  return (
    ...
    >
      <motion.div
        className="absolute -inset-2 bg-gradient-radial from-transparent via-blue-400/30 via-30% via-purple-400/30 via-60% via-blue-400/30 via-90% to-transparent rounded-3xl z-0 pointer-events-none"
